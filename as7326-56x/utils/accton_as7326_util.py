...
args = []
ALL_DEVICE = {}               
DEVICE_NO = {'led':5, 'fan':6,'thermal':4, 'psu':2, 'sfp':56}
FORCE = 0
...
'echo as7326_56x_fan 0x66 > /sys/bus/i2c/devices/i2c-2/new_device ',
...
'echo as7326_56x_psu1 0x53 > /sys/bus/i2c/devices/i2c-11/new_device',
'echo ym2651 0x5b > /sys/bus/i2c/devices/i2c-11/new_device',
'echo as7326_56x_psu2 0x50 > /sys/bus/i2c/devices/i2c-10/new_device',
'echo ym2651 0x58 > /sys/bus/i2c/devices/i2c-10/new_device',
'echo as7326_56x_cpld1 0x60 > /sys/bus/i2c/devices/i2c-4/new_device',
'echo as7326_56x_cpld2 0x62 > /sys/bus/i2c/devices/i2c-5/new_device',
'echo as7326_56x_cpld3 0x64 > /sys/bus/i2c/devices/i2c-6/new_device']
