...
static void accton_as7312_54x_led_update(void)
{
    ...
    if (time_after(jiffies, ledctl->last_updated + HZ + HZ / 2)
        ...
        for (i = 0; i < ARRAY_SIZE(ledctl->reg_val); i++) {
            int status = accton_as7312_54x_led_read_value(led_reg[i]);
...
static void accton_as7312_54x_led_psu_1_set(struct led_classdev *led_cdev,
                                            enum led_brightness led_light_mode)
{
    accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[1], LED_TYPE_PSU1);
}

static enum led_brightness accton_as7312_54x_led_psu_1_get(struct led_classdev *cdev)
{
    accton_as7312_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_PSU1, ledctl->reg_val[1]);
}

static void accton_as7312_54x_led_psu_2_set(struct led_classdev *led_cdev,
                                            enum led_brightness led_light_mode)
{
    accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[1], LED_TYPE_PSU2);
}

static enum led_brightness accton_as7312_54x_led_psu_2_get(struct led_classdev *cdev)
{
    accton_as7312_54x_led_update();
    return led_reg_val_to_light_mode(LED_TYPE_PSU2, ledctl->reg_val[1]);
}

static void accton_as7312_54x_led_fan_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_FAN);
}

static enum led_brightness accton_as7312_54x_led_fan_get(struct led_classdev *cdev)
{
    accton_as7312_54x_led_update();
...
static void accton_as7312_54x_led_fanx_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    ...
    for(i=0;i<ncount;i++)
    {
        ...
        if (led_cdev->name[nsize-1] == fanx_info[i].cname)
        {
            ...
            accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[reg_id], led_type1);
            return;
        }
    }
}
...
static enum led_brightness accton_as7312_54x_led_fanx_get(struct led_classdev *cdev)
{
    enum led_type led_type1;
    int reg_id;
    int i, nsize;
...
static void accton_as7312_54x_led_diag_set(struct led_classdev *led_cdev,
                                           enum led_brightness led_light_mode)
{
    accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_DIAG);
}
...
static void accton_as7312_54x_led_loc_set(struct led_classdev *led_cdev,
                                          enum led_brightness led_light_mode)
{
    accton_as7312_54x_led_set(led_cdev, led_light_mode, led_reg[0], LED_TYPE_LOC);
}
...
static struct led_classdev accton_as7312_54x_leds[] = {
    [LED_TYPE_PSU1] = {
        ...
        .brightness_set     = accton_as7312_54x_led_psu_1_set,
        .brightness_get  = accton_as7312_54x_led_psu_1_get,
    ...
    [LED_TYPE_PSU2] = {
        ...
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_psu_2_set,
        .brightness_get  = accton_as7312_54x_led_psu_2_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN] = {
        ...
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fan_set,
        .brightness_get  = accton_as7312_54x_led_fan_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN1] = {
        .name             = "accton_as7312_54x_led::fan1",
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fanx_set,
        .brightness_get  = accton_as7312_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
        .max_brightness  = LED_MODE_AUTO,
    },
    [LED_TYPE_FAN2] = {
        .name             = "accton_as7312_54x_led::fan2",
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fanx_set,
        .brightness_get  = accton_as7312_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN3] = {
        .name             = "accton_as7312_54x_led::fan3",
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fanx_set,
        .brightness_get  = accton_as7312_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN4] = {
        .name             = "accton_as7312_54x_led::fan4",
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fanx_set,
        .brightness_get  = accton_as7312_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
    ...
    [LED_TYPE_FAN5] = {
        .name             = "accton_as7312_54x_led::fan5",
        .default_trigger = "unused",
        .brightness_set     = accton_as7312_54x_led_fanx_set,
        .brightness_get  = accton_as7312_54x_led_fanx_get,
        .flags             = LED_CORE_SUSPENDRESUME,
