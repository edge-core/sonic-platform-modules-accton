			 ...
			 const struct i2c_device_id *id)
{
    ...
    if (data->type == as7312_54x_cpld2 || data->type == as7312_54x_cpld3) {
...
#if 0 /*  i2c i2c-0: Segment 7 behind mux can't share classes with ancestors */
...
#if 0
        idx = (data->type - as7312_54x_cpld2) * NUM_OF_CPLD2_CHANS + chan;
