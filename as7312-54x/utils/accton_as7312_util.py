...
led_prefix ='/sys/devices/platform/as7312_54x_led/leds/accton_'+PROJECT_NAME+'_led::'
fan_prefix ='/sys/devices/platform/as7312_54x_'
...
sfp_map =  [2, 3, 4, 5, 6, 7, 8, 9, 10,
            ...
            50, 52, 54, 51, 53, 55]
mknod =[
'echo as7312_54x_cpld1 0x60 > /sys/bus/i2c/devices/i2c-0/new_device',
'echo as7312_54x_cpld2 0x61 > /sys/bus/i2c/devices/i2c-0/new_device',
'echo as7312_54x_cpld3 0x62 > /sys/bus/i2c/devices/i2c-0/new_device',
'echo pca9548 0x70 > /sys/bus/i2c/devices/i2c-1/new_device',

# PSU-1
'echo as7312_54x_psu1 0x38 > /sys/bus/i2c/devices/i2c-57/new_device',
'echo cpr_4011_4mxx  0x3c > /sys/bus/i2c/devices/i2c-57/new_device',
'echo as7312_54x_psu1 0x50 > /sys/bus/i2c/devices/i2c-57/new_device',
'echo ym2401 0x58 > /sys/bus/i2c/devices/i2c-57/new_device',

# PSU-2
'echo as7312_54x_psu2 0x3b > /sys/bus/i2c/devices/i2c-58/new_device',
'echo cpr_4011_4mxx 0x3f > /sys/bus/i2c/devices/i2c-58/new_device',
'echo as7312_54x_psu2 0x53 > /sys/bus/i2c/devices/i2c-58/new_device',
...
mknod2 =[
'echo as7312_54x_cpld1 0x60 > /sys/bus/i2c/devices/i2c-1/new_device',
'echo as7312_54x_cpld2 0x61 > /sys/bus/i2c/devices/i2c-1/new_device',
'echo as7312_54x_cpld3 0x62 > /sys/bus/i2c/devices/i2c-1/new_device',
...
'modprobe i2c-mux-accton_as7312_54x_cpld',
'modprobe cpr_4011_4mxx',
'modprobe ym2651y',
'modprobe accton_as7312_54x_fan',
'modprobe accton_as7312_54x_sfp',
'modprobe leds-accton_as7312_54x',
...
def device_install():
    ...
    for i in range(0,len(sfp_map)):
        status, output =log_os_system("echo as7312_54x_sfp"+str(i+1)+" 0x50 > /sys/bus/i2c/devices/i2c-"+str(sfp_map[i])+"/new_device", 1)
        if status:
            print output
            if FORCE == 0:
                return status
